  ...
  <div class="container">
    <div class="svc-overview-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:center">
      ...
      <div class="svc-overview-visual reveal reveal-delay-2" style="position:relative">
        <div class="svc-overview-image-frame" style="border-radius:20px;overflow:hidden;aspect-ratio:3/4"><img src="https://darkseagreen-stinkbug-382389.hostingersite.com/wp-content/uploads/2026/06/School-based-ABA-programs-scaled.webp" alt="School-based ABA session" style="width:100%;height:100%;object-fit:cover"></div>
