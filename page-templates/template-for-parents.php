  ...
  <div class="container">
    <div class="svc-overview-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:center">
      ...
      <div class="svc-overview-visual reveal reveal-delay-2" style="position:relative">
        <div class="svc-overview-image-frame" style="border-radius:20px;overflow:hidden;aspect-ratio:4/3"><img src="https://images.unsplash.com/photo-1516627145497-ae6b53e6b06f?w=800&q=80&fit=crop" alt="Parent coaching" style="width:100%;height:100%;object-fit:cover"></div>
